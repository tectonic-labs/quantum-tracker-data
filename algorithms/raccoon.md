# Raccoon — PQC Adoption Across L1s

| | |
|---|---|
| **Type** | Signature |
| **Cryptographic family** | Lattice (masked) |
| **NIST standardization** | Submitted to NIST additional-signatures call |
| **Typically replaces** | ECDSA / EdDSA |
| **L1 blockchains tracked** | 1 |

Raccoon is a lattice-based signature scheme designed for masking-friendly, side-channel-resistant implementation. It was submitted to NIST's call for additional digital signatures and is not standardized.
