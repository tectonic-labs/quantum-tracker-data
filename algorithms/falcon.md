...
- ✅ **[Algorand](../chains/l1/algorand.md)**
  ...
  - On-Chain — In Development (experimental AVM opcode)
...
- ⚠️ **[BNB Chain](../chains/l1/bnb-chain.md)** — On-Chain — Discussed (BEP-575 proposal, now stale)
