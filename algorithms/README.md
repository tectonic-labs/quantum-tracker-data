...
| [CSIDH-1024](csidh-1024.md) | Other | -- | -- | 0 | 0 | 0 | 1 | 1 |
| [Lamport-OTS (Lamport One-Time Signatures, RIPEMD-160-based PoC)](lamport-ots-lamport-one-time-signatures-ripemd-160-based-poc.md) | Other | -- | -- | 0 | 0 | 1 | 0 | 1 |
