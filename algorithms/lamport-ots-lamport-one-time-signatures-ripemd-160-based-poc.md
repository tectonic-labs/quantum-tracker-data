# Lamport-OTS (Lamport One-Time Signatures, RIPEMD-160-based PoC) — PQC Adoption Across L1s
...
- ⚠️ **[Bitcoin Cash](../chains/l1/bitcoin-cash.md)** — On-Chain (smart contract) — Discussed (proof-of-concept; no wallet or dapp uses it)
